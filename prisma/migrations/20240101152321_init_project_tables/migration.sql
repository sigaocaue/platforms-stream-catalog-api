...
CREATE TABLE `content_availabilities` (
    ...
    PRIMARY KEY (`streaming_platform_id`, `content_id`, `entry_date`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `content_contributions` (
    ...
    PRIMARY KEY (`content_id`, `person_id`, `contribution_role_name`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `content_titles` ADD CONSTRAINT `content_titles_content_id_fkey` FOREIGN KEY (`content_id`) REFERENCES `streaming_content`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `content_contributions` ADD CONSTRAINT `content_contributions_content_id_fkey` FOREIGN KEY (`content_id`) REFERENCES `streaming_content`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
